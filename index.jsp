...
<form action="register" method="get" style="max-width:500px;margin:auto">
...
<div class="input-container" >
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="password" placeholder="Password" name="pass" id="pass" title="Enter password here">
</div>
